    ...
    >
      ...
      >
        <img
          ...
          src="https://drive.google.com/uc?export=download&id=1-8GS2UQ9zzWUg3akMbSx6q_FqaFgR80f"
          alt=""
        />
      </div>
      <div
      ...
      >
        ...
        >
        My interest in Computer Programming I started back in 2019 when I decide
          to check the elements on the github — turns out that all the Elements
          I see on the browser was HTML amd CSS!. Fast-forward, now I'm continue to finish
          my studies to beacome a Frontend Developer someday  with year's of  work experience.
        </div>
        <div
